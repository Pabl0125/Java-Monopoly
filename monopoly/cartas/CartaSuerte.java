...
public class CartaSuerte extends Carta {
    ...
    public void accion(Tablero tablero, Jugador jugadorActual, ArrayList<Jugador> jugadores) {
        Juego.consola.imprimir("Has sacado la carta de Suerte número " + this.getNum() + ":");
        ...
        switch (getNum()) {
            ...
            case 7:
                ...
                Juego.consola.imprimir("Si caes en una propiedad de otro jugador, el pago será el doble de lo normal.");

                if (duenho.getNombre().equals("Banca")) {
                    Juego.consola.imprimir("La propiedad no tiene dueño. Puedes comprarla si lo deseas.");
                    ...
                    Juego.consola.imprimir("La propiedad tiene dueño. Debes pagar el doble: " + (pagoNormal * 2) + "€.");
