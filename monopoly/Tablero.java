...
public class Tablero {
    ...
    private void generarCasillas() {
        // Lado Sur
        casillas.add(new Especial("Salida", 0));
        ...
        casillas.add(new CajaComunidad("Caja", 2));
        ...
        casillas.add(new Impuesto("Imp1", 4));
        ...
        casillas.add(new Suerte("Suerte", 7, juego.getJugadores()));
        ...
        // Lado Oeste
        casillas.add(new Especial("Carcel", 10));
        ...
        casillas.add(new CajaComunidad("Caja", 17));
        ...
        // Lado Norte
        casillas.add(new Parking("Parking", 20));
        ...
        casillas.add(new Suerte("Suerte", 22, juego.getJugadores()));
        ...
        // Lado Este
        casillas.add(new Especial("IrACarcel", 30));
        ...
        casillas.add(new CajaComunidad("Caja", 33));
        ...
        casillas.add(new Suerte("Suerte", 36, juego.getJugadores()));
        ...
        casillas.add(new Impuesto("Imp2", 38));
